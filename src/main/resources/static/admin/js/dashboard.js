...
function viewBooking(bookingId) {
    ...
    document.getElementById('bookingDetailPrice').textContent = '
...
function viewBooking(bookingId) {
    ...
    const user = users.find(u => u.id === booking.userId) || { name: 'Unknown', email: 'Unknown' };
    const car = cars.find(c => c.id === booking.carId) || { brand: 'Unknown', model: 'Unknown' };
...
function logoutAdmin() {
    ...
    document.getElementById('bookingDetailUserPhone').textContent = user.phone;
